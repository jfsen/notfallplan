...
const PickIcons = {
  ...
  toolbox: SVGs.toolbox,
  dumbbell: SVGs.dumbbell,
  quote: SVGs.quote,
  pill: SVGs.pill,
  ...
  group: SVGs.group,
  shield: SVGs.shield,
  parachute: SVGs.parachute,
  gauge: SVGs.gauge,
  bandage: SVGs.bandage,
  pepper: SVGs.pepper,
  carrot: SVGs.carrot,
  doctor: SVGs.doctor,
  masks: SVGs.masks,
